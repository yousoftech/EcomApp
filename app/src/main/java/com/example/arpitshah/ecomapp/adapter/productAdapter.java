...
public class productAdapter extends RecyclerView.Adapter<productAdapter.RecyclerViewHolder> {
    ...
    public productAdapter(Context context, ArrayList<Category> event) {
        this.event = event;
    ...
    public RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate( R.layout.productsrecyclerrow, parent, false );
    ...
    public class RecyclerViewHolder extends RecyclerView.ViewHolder {
        ...
        public RecyclerViewHolder(View itemView) {
            super( itemView );
            txt_CategoryName = (TextView) itemView.findViewById( R.id.prodName );
